                  ...
                  <div className="flex h-[100vh] flex-col overflow-y-scroll bg-blackFred-300 shadow-xl">
                    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-lg font-bebas text-whiteFred-100">Shopping cart</Dialog.Title>
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  <div>
                                    <div className="flex justify-between text-base font-monse text-whiteFred-100">
                                      <h3>
                                        <a href={product.href} className='text-whiteFred-100 hover:text-orangeFred-300'>{product.name}</a>
                                      </h3>
                                  ...
                                  <div className="flex flex-1 items-end justify-between text-sm">
                                    <p className="text-white-300">Quantity {product.quantity}</p>
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                      ...
                      <p className="mt-0.5 text-sm text-whiteFred-300">Shipping and taxes calculated at checkout.</p>
                      <div>
                        <a
                          href="#"
