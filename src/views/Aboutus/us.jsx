...
export default function Aboutus() {
  return (
    <section class="text-gray-600 body-font">
      <div class="flex flex-col mt-8 mx- items-center ">
        <div class="flex flex-col text-center w-full h-64 mx-0 mb-12 relative sm:h-80">
          ...
          <div class="relative z-10 mt-8 sm:mt-2">
            <h1 class="xl:text-25xl font-bebas mb-4 text-orangeFred-100">
              Jenshy Team
            </h1>
            <p class="xl:w-2/3 mx-auto leading-relaxed font-monse text-orangeFred-200  sm:text-4xl mx-8">
            Greetings! We are a passionate team of 8 dedicated developers committed to 
            creating the best online experience for fitness enthusiasts and sports
             supplement seekers. Together, we blend technology with a love for wellness 
             to bring you an intuitive and functional platform.
            </p>
          </div>
        </div>

        <div class="xl:grid grid-cols-4 gap-16 mb-16 mx-12 ">
          {/* lucas card */}
