...
export default function Header() {
  ...
  return (
    <div className="relative bg-[#121212] w-full h-[960px] overflow-x-hidden text-left text-21xl text-whiteFred-300 font-impact">
      <img
        className=" relative  top-[10px] left-[280px] w-[1700px] h-[full] object-cover"
        alt=""
        src={bg}
      />
      <p className="absolute top-[731px] left-[319px] leading-[32px] flex items-center w-24 h-[34px] text-blackFred-100">
        YOUR
      </p>
      <p className="absolute top-[827px] left-[303px] leading-[32px] flex items-center w-[129px] h-[34px] text-blackFred-100">
        FOREVER
      </p>
      ...
      <p className="absolute top-[341px] left-[137px] text-5xl leading-[32px] font-impact text-blackFred-100">
        BEST
      </p>
      <p className="absolute top-[402px] left-[137px] text-5xl leading-[32px] font-impact text-blackFred-100">
        SUPPLEMENT
      </p>
      <p className="absolute top-[463px] left-[137px] text-5xl leading-[32px] font-impact text-orangeFred-300">
        SELLERS
      </p>
      <NavLink to="/home" className="absolute rounded-xl top-[589px] left-[206px] leading-[32px] font-impact text-blackFred-100 hover:text-orangeFred-300">
        shop now
      </NavLink>
      <p className="absolute top-[31px] left-[1297px] text-3xl leading-[32px] flex items-center w-44 h-[39px] text-grey">
        ONLINE
      </p>
      <p className="absolute top-[131px] left-[1317px] text-3xl leading-[32px] flex items-center w-[174px] h-[38px] text-blackFred-100">
        STORE
      </p>
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center text-whiteFred-300 z-10">
    ...
    <div className="w-96 rounded-sm p-2.5 mb-4">
      <p className="text-lg text-whiteFred-300 text-10xl text-center">
    ...
    <div className="w-96 rounded-xl bg-redFred-300 h-24 flex items-center justify-center">
      <NavLink to="/home" className="text-30-xl text-whiteFred-300 hover:text-orangeFred-300 font-impact tracking-wide">
        Get started
      </NavLink>
    </div>
  </div>
