...
export default function Header() {
  ...
  return (
    <div className="relative flex flex-col m-auto text-center bg-blackFred-300 w-full xl:h-[850px] sm:h-[800px] py-5 text-whiteFred-100 font-impact">
      <div className="sm:flex-row xl:flex-col flex flex-col items-center">
        ...
        <div className="sm:ml-4 xl:ml-0 absolute inset-0">
          ...
          <button to="/products" className="bg-redFred-300 font-impact sm:text-[25px] rounded-xl shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)_inset] w-full sm:w-[250px] xl:w-[300px] h-16 mt-6 sm:mt-[100px] xl:ml-[1100px] xl:text-21xl xl:mt-[300px] mx-auto">
