    ...
    <>
      {isLoading ? <Loader /> : <div className="sticky mt-[20px] bg-whiteFred-100 ">
        <table>
          <thead>
            <tr>
              <th className="bg-graym text-blackFred-100 py-[20px] px-[80px]">Given Name</th>
              <th className="bg-graym text-blackFred-100 py-[20px] px-[80px]">Family Name</th>
              <th className="bg-graym text-blackFred-100 py-[20px] px-[80px]">Email</th>
              <th className="bg-graym text-blackFred-100 py-[20px] px-[80px]">Address</th>
              <th className="bg-graym text-blackFred-100 py-[20px] px-[80px]">Role</th>
              <th className="bg-graym text-blackFred-100 py-[20px] px-[80px]">Status</th>
              <th className="bg-graym text-blackFred-100 py-[20px] px-[80px]">Actions</th>
              <th></th>
            </tr>
          </thead>
          <tbody>
