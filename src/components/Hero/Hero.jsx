    ...
    return (
        <div >
            ...
            {/* <img src={Home} alt="" className="w-[full] h-[40vw] object-cover" / > */}
                ...
                <p className="ml-[-200px] font-impact text-30xl text-whiteFred-300 mb-[0px]">GET THE APP</p>
                <NavLink to="/#" className="ml-[-400px] z-10 font-impact  leading-[32px] text-orangeFred-300 hover:text-redFred-300">SOON...</NavLink><br/>
            ...
            <div className=" ml-[60px] mb-[40px] bg-[#1e1e1e] w-[540px] h-[600px]">
                ...
                <p className=" font-impact text-30xl text-whiteFred-300 mb-[0px]">VITAMINS</p>
            ...
            <div className="ml-[60px] mb-[40px] bg-[#1e1e1e] w-[540px] h-[600px]">
                ...
                <p className=" font-impact text-30xl text-whiteFred-300 mb-[0px]">SUPPLEMETS</p>
                <NavLink to="/products" className=" font-impact  leading-[32px] text-orangeFred-300 hover:text-redFred-300">SHOP NOW</NavLink>
            </div>
            </section>
        </div>
